...
def func_target(v_ctrl_Grammar_Path,v_ctrl_Grammar_Name,v_ctrl_Notebook_Name , v_ctrl_Notebook_Path):
#{
    global outF
    v_grammar_Path = v_ctrl_Grammar_Path + '\\' + v_ctrl_Grammar_Name
    with open(v_grammar_Path) as json_file:
...
#{
    ...
    for index, row in df_pd_dataflowlist.iterrows():
        ...
        #{
            ...
            #func_target(v_ctrl_Notebook_Path,v_ctrl_Notebook_Name)
            outF.write('\t'+ "print(s_df_1.count())" + '\n')
